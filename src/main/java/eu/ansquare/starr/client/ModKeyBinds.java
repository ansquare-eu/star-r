...
public class ModKeyBinds {
	...
	private static KeyBind addPowerKey;
	private static KeyBind substractPowerKey;
	...
	public static void init(){
		...
		substractPowerKey = KeyBindingHelper.registerKeyBinding(new KeyBind(
				"key.starr.subtract", // The translation key of the keybinding's name
				InputUtil.Type.KEYSYM, // The type of the keybinding, KEYSYM for keyboard, MOUSE for mouse.
		...
		addPowerKey = KeyBindingHelper.registerKeyBinding(new KeyBind(
				"key.starr.add", // The translation key of the keybinding's name
				InputUtil.Type.KEYSYM, // The type of the keybinding, KEYSYM for keyboard, MOUSE for mouse.
